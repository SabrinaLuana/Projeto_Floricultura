        ...
        <div class="admin-content">
            ...
            <section id="clientes">
                ...
                <div class="form-container">
                    <h2>Cadastrar Flores</h2>
                    <form method="POST">
                        <input type="text" placeholder="Nome" required name="nome" autocomplete="off">
                        <input type="number" min="1" step="any" placeholder="preço" required name="preco" autocomplete="off">
                        <input type="number" min="1" step="any" placeholder="Quantidade" required  name="qtd" autocomplete="off">
                        <button type="submit" name="cadastrar">Cadastrar Flor</button>
                    </form>
                </div>
